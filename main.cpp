...
int main()
  {
    ...
    // Declearing three character variable named door1, door2, and door3 respectively for storing
    // the value of the object behind the door

    int doorPlayer, doorMonty;
    // Declearing two integer variables  named doorPlayer, and doorMonty to stroe the  position
    // of the door they pick up

    int seed = static_cast<int>(time(0));
    // Declearing and initializing an integer variable seed, using the system's clock
    srand(seed);
...
// the Car and the two Goats randomly behind the three doors
  ...
  {
        int door;
        //Declearing a integer variable door to store the number of the door
...
// for the door that will be picked by Monty acccording to the choice of the Player
  ...
  {
        int r1  =  1 + rand()  %  3;
        //Declearing anb initializing the integer variable r1  by random numbers from 1 to 3 using rand() function
        doorPlayer  =  r1 ;
     ...
     // for the door that will be picked by Monty acccording to the choice of the Player
       {
                int r2 = 1 + rand()  %  3;
                 //Declearing anb initializing the integer variable r2  by random numbers from 1 to 3 using rand() function
                doorMonty  =  r2;
...
//of winning in different situations
  ...
  {
        int win_in_change = 0;
        //Declearing anb initializing the integer variable win_in_change  with 0
        int lose_in_change = 0;
        //Declearing anb initializing the integer variable lose_in_change  with 0
        int changingWon_percent = 0;
        //Declearing anb initializing the integer variable changingWon_percent  with 0

        int win_without_change = 0;
        //Declearing anb initializing the integer variable win_without_change  with 0
        int lose_without_change = 0;
        //Declearing anb initializing the integer variable lose_without_change  with 0
        int stayingWon_percent = 0;
        //Declearing anb initializing the integer variable stayingWon_percent  with 0
